            ...
            <footer>
                <section className="flex gap-[8em] px-[4em]">
                    ...
                    <div className="w-full">
                        ...
                        <div className="flex border-b-2 border-black"><input type="text" className="w-full outline-none placeholder:text-black placeholder:font-bold" placeholder="Enter your email address" /><h1 className="font-bold text-[22px] text-[#F6623C]">SUBSCRIBE</h1></div>
                    </div>
